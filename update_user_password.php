<?php include("header.php") ?>
  ...
  <div id="page-wrapper">
    ...
    include('config.php');
    $row=$_REQUEST['id'];
     $data=mysqli_fetch_array(mysqli_query($con, "select * from reg_user where id='$row'")); ?>
       ...
       <div class="form-group col-lg-6">
        ...
        <a href="reg_user.php" class="btn btn-primary">Back</a>
      </div>
      ...
      <?php
          if (isset($_POST['terms']))
           ...
           $pass=$_REQUEST['password'];
             $query="update reg_user set password='$pass' where id=$rowid";
              if (mysqli_query($con,$query))
                 {      
                    ?>
                  <script>
                         window.location='reg_user.php';
                  </script>
